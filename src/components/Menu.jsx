...
const Menu = () => {
  ...
  const [menuButtons, setMenuButtons] = useState([
    <InicioButton color="black-button" />,
    <InfoButton color="white-button" />,
  ...
  useEffect(() => {
    ...
    if (sesion.logueado) {
      setMenuButtons([
        <InicioButton color="black-button" />,
        <InfoButton color="white-button" />,
        <JugarButton color="black-button" />,
        <SesionButton color="white-button" />,
      ]);
    } else {
      setMenuButtons([
        <InicioButton color="black-button" />,
    ...
    <div className="menu">
      <a href="/" className="logo">
        <div className="left-menu-div">
          <img
            alt="ChessTer"
            src={process.env.PUBLIC_URL + "/logoChessTer.jpeg"}
            className="menu-logo"
          ></img>
          <h1>ChessTer</h1>
        </div>
